...
inline void drawColor( int c ){
	drawColor( static_cast<COLOR>(c) );
}
...
inline void setCamera( float x, float y )
{
	...
	*/
	...
	gluLookAt( SCREEN_WIDTH/2.f + x , SCREEN_HEIGHT/2.f + y, 0.f, SCREEN_WIDTH/2.f + x , SCREEN_HEIGHT/2.f + y, -1.0f, 0.0f, 1.0f, 0.0f );
}
